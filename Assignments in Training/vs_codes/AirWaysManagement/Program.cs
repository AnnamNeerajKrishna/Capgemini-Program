...
using System.Data;
using AirwaysBusinessAccessLayer;
namespace AirWaysManagement
{
    public class Program
    {
        ...
        {
            //SqlConnection cne = new SqlConnection("Data Source=LAPTOP-L67T7EHI;Initial CatalogAirways;Integrated Security=True");
            SqlConnection cne = new SqlConnection("Data Source=LAPTOP-L67T7EHI;Initial CatalogAirways;Integrated Security=True");
            ...
            while (sdr.Read())
            {
                ...
                while (p)
                {
                    ...
                    if (choice == 1)
                    {
                        AirwaysBusinessAccess A = new AirwaysBusinessAccess();
                        A.ChangeTimings();
                    }
                    else if (choice == 2)
                    {
        ...
        public static bool AddUser()
        {
            try
            {
                LoginEntity k = new LoginEntity();
                Console.WriteLine("Enter UserIdName");
                ...
                AirwaysBusinessAccess Ab = new AirwaysBusinessAccess();
